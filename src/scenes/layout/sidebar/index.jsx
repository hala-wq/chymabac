...
import {
  ...
  InfoOutlined,
  CategoryOutlined,
  LibraryBooksOutlined // Ajouter un nouvel icône pour Contrat
    ...
    >
      ...
      <Box mb={5} pl={collapsed ? undefined : "5%"}>
        <Menu menuItemStyles={menuItemStyles}>
          ...
          {openInfo && (
            <>
              <Item key="client" title="Client" path="/client" colors={colors} icon={<PeopleAltOutlined />} sx={{ fontSize: "10px" }} />
              <Item key="vehicules" title="Vehicules" path="/Vehicules" colors={colors} icon={<DirectionsCar />} sx={{ fontSize: "10px" }} />
              <Item key="Categorie" title="Categorie" path="/Categorie" colors={colors} icon={<CategoryOutlined  />} sx={{ fontSize: "10px" }} />
              {/* Ajouter l'élément Contrat ici */}
              <Item key="contrat" title="Contrat" path="/Contrat" colors={colors} icon={<LibraryBooksOutlined />} sx={{ fontSize: "10px" }} />
            </>
          )}
